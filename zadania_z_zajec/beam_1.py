...
if __name__ == '__main__':
    ...
    b = float(input("Podaj szerokość przekroju belki w m: "))
    h = float(input("Podaj wysokość przekroju belki w m: "))
    E = int(input("Podaj wartość moduły Younga E w Pa: "))
    v = float(input("Podaj wartość współczynnika Poissona: "))
    fy = int(input("Podaj wartość granicy plastyczności stali w Pa: "))
    behaviour = input("Podaj sposób zachowania belki np.'elastic': ")
    
    # Jednostki m, N, Nm, Pa
    MyBeam = Beam(L, P, a, CrossSection(b, h), Material(E, v, fy, behaviour))
